package main.beans.factory.xml;
...
import main.beans.factory.support.AbstractBeanDefinitionReader;
import main.beans.factory.support.BeanDefinitionRegistry;
        ...
        for (int i = 0; i < childNodes.getLength(); i++)
        {
            ...
            for (int j = 0; j < bean.getChildNodes().getLength(); j++)
            {
                ...
                Object value = StrUtil.isNotEmpty(attrRef) ?
                        new BeanReference(attrRef) : attrValue;
                // 创建属性信息
